...
![SHAP](https://img.shields.io/badge/SHAP-6C3483?style=flat-square)
![Scapy](https://img.shields.io/badge/Scapy-2C8EBB?style=flat-square)
...
> **Production SaaS · 200+ Active Users · Zero Critical Incidents**

AI influencer-brand matching platform. Containerized microservices with full CI/CD automation, AWS S3 for media storage, and AWS ECR for container registry.
...
| Domain | Tools |
|--------|-------|
| **AI / ML** | LangGraph · LangChain · LLMs · GNN · XGBoost · PSO · ACO · PyTorch · Groq · SHAP |
| **Backend** | Python · FastAPI · Node.js · Express |
| **Frontend** | Next.js · React · TypeScript · Tailwind CSS |
| **Infrastructure** | Docker · GitHub Actions · AWS · Google Cloud · Kafka · Grafana |
| **Databases** | PostgreSQL · MongoDB · Firebase · Supabase |
| **Research** | ns3 · Scapy · Scikit-learn · Jupyter · LaTeX |
...
<div align="center">
  <img width="49%" src="https://github-readme-stats.vercel.app/api?username=qasim-you&show_icons=true&theme=tokyonight&hide_border=true&include_all_commits=true&count_private=true" />
